...
public class DiscordMessageMentionsMeEvent extends DiscordEvent implements Cancellable {
	/**
	...
	/**
	 * Used when a new DiscordMessageMentionsMeEvent is fired by Discord.
	 ...
	 */
	public DiscordMessageMentionsMeEvent(Message message, User user, ServerTextChannel channel, DiscordApi api) {
		super(api);
